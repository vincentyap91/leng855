...
function SideLink({ label, icon, badge, active }) {
    return (_jsxs("button", { type: "button", className: [
        ...
        }, children: [_jsx("img", { src: icon, alt: "", className: "side-nav-icon w-[24px] h-[24px] object-contain shrink-0 transition" }), _jsx("span", { className: [
...
export function Sidebar() {
    return (_jsxs("aside", { className: "w-[220px] shrink-0 bg-bg-sidebar relative pb-4 border-r", style: {
