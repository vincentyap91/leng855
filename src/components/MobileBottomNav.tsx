...
const itemClass =
  "mobile-bottom-nav__btn flex flex-1 flex-col items-center rounded-lg justify-center gap-0.5 border-0 bg-transparent px-1 py-2 text-[10px] font-semibold leading-tight text-[var(--mobile-nav-fg)] min-w-0";
